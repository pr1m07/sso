  ...
  <div class="panel-body">
	...
	?>
		<tr>
			...
			<td><a href="<?=base_url()?>admin/editcloud/<?=$row['cID']?>"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span> edit</button></a> <a href="<?=base_url()?>admin/linkuser/<?=$row['cID']?>"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-user"></span> link user</button></a> <a href="<?=base_url()?>admin/cloud/<?=$row['cID']?>"><button type="button" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-search"></span> view</button></a> <a href="<?=base_url()?>admin/auth/<?=$row['cID']?>/<?=$this->session->userdata('userID')?>" target="_blank" ><button type="button" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-cloud"></span> login</button></a> <a href="<?=base_url()?>admin/deletecloud/<?=$row['cID']?>"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> delete</button></a></td>
		</tr>
